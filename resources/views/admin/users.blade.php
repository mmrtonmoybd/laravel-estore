      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="tile-title-w-btn">
              ...
              <p><a class="btn btn-primary icon-btn" href="{{ route('admin.user.add') }}"><i class="fa fa-plus"></i>Create User</a></p>
              </div>
            <div class="tile-body">
              ...
              <div class="table-responsive">
                ...
                <label>Order By: 
                  <select name="sampleTable_length" aria-controls="sampleTable" class="form-control form-control-sm">
                    <option onClick="window.location = '{{ route("admin.user.list") }}'">Latest(Default)</option>
                    <option onClick="window.location = '{{ route("admin.user.list") }}?order=older'">Oldest</option>
                  </select></label>
                  </div>
                </div>
                </div>
