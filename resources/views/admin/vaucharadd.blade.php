	  ...
	  <div class="row">
        <div class="col-md-12">
          <div class="tile">
            ...
            @endforeach
                <form action="{{ route('admin.vauchar.add') }}" method="POST">
                @csrf
				<div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control @error('id') is-invalid @enderror" id="exampleInputQty1" type="text" placeholder="Enter ID" name="id" required value="{{ old('id') }}">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control @error('code') is-invalid @enderror" id="exampleInputQty1" type="text" placeholder="Code" name="code" required value="{{ old('code') }}">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control @error('value') is-invalid @enderror" id="exampleInputQty1" type="text" placeholder="Value" name="value" required value="{{ old('value') }}">
                  </div>
